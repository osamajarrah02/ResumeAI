...
namespace ResumeAI.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.PersonFirstName = Input.PersonFirstName;
                user.PersonLastName = Input.PersonLastName;
                user.Points = 50;
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        new Claim("FirstName", user.PersonFirstName),
                        new Claim("LastName", user.PersonLastName),
